...
// Icons for UI
export const ICONS = {
    EXPAND: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"></path></svg>`,
    COLLAPSE: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 19h3v-3h2v5H8v-2zm3-8h5v-2H8v5h2v-3zm6-8v3h3v2h-5V5h2zm-8 5H5V8h5v3z"></path></svg>`,
    ...
    RESYNC: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"></path></svg>`
};
